...
class Vibrate {
  static const MethodChannel _channel =
      const MethodChannel('flutter_device_vibrate');
  ...
  static Future vibrate() => _channel.invokeMethod('flutter_device_vibrate',
      {'duration': _DEFAULT_VIBRATION_DURATION.inMilliseconds});
